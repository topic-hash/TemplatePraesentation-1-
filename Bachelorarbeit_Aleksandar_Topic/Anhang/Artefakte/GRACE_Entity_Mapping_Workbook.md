...
|------|----------|----------|--------------|---------|-------------|
| `id` | string | [OK] Ja | Eindeutiger Bezeichner | - | Format: `lowercase-with-hyphens`, Regex: `^[a-z0-9-]+$` |
| `name` | string | [OK] Ja | Anzeigename des Materials | - | Menschenlesbar, keine Sonderzeichen empfohlen |
| `comment` | string | [FEHLER] Nein | Optionale Beschreibung oder Verwendungshinweis | `""` | Freitext |
...
|------|----------|----------|--------------|---------|-------------|
| `id` | string | [OK] Ja | Eindeutiger Bezeichner | - | Format: `lowercase-with-hyphens`, Regex: `^[a-z0-9-]+$` |
| `name` | string | [OK] Ja | Anzeigename der Maschine | - | Menschenlesbar |
| `operatingCosts` | object | [OK] Ja | Betriebskosten-Objekt | - | Siehe Sub-Struktur |
| `operatingCosts.type` | string | [OK] Ja | Kostentyp | `"Constant"` | Werte: `"Constant"` oder `"Variable"` |
| `operatingCosts.value` | number | [OK] Ja | Kostenwert pro Zeiteinheit | `0` | ≥ 0, keine negativen Werte |
| `isSpatial` | boolean | [OK] Ja | Räumliche Ressource | `false` | `true` nur bei expliziter Anforderung |
| `initialUnits` | number | [OK] Ja | Anzahl verfügbarer Einheiten | `1` | ≥ 1, bei "3 Mixer" = 3 |
| `unitsAutoGrow` | boolean | [OK] Ja | Automatische Kapazitätserweiterung | `false` | Standard immer `false` |
...
| Feld | Datentyp | Required | Beschreibung | Default | Constraints |
|------|----------|----------|--------------|---------|-------------|
| `id` | string | [OK] Ja | Eindeutiger Bezeichner | - | Format: `{produktname}-prod`, Regex: `^[a-z0-9-]+$` |
| `name` | string | [OK] Ja | Produktname | - | Exakter Name des Produkts |
| `material` | object | [OK] Ja | Referenz zum resultierenden Material | - | Siehe Sub-Struktur |
| `material.version` | number | [OK] Ja | Versionsangabe | `1` | Immer `1` |
| `material.id` | string | [OK] Ja | Material-ID | - | **WICHTIG:** Entspricht dem Produktnamen (nicht Zutat!) |
...
| Feld | Datentyp | Required | Beschreibung | Default | Constraints |
|------|----------|----------|--------------|---------|-------------|
| `id` | string | [OK] Ja | Eindeutiger Bezeichner | - | Format: `lowercase-with-hyphens` |
| `name` | string | [OK] Ja | Prozessname | - | Beschreibend |
| `steps` | array | [OK] Ja | Array von Prozessschritten | - | Mindestens 1 Schritt |
| `steps[].id` | string | [OK] Ja | Schritt-ID | - | Format: `step-1`, `step-2`, ... |
| `steps[].name` | string | [OK] Ja | Schrittname | - | z.B. "Dosing", "Mixing" |
| `steps[].processingTime` | object | [OK] Ja | Zeitangabe-Objekt | - | Siehe Sub-Struktur |
| `steps[].processingTime.type` | string | [OK] Ja | Zeittyp | `"Constant"` | Standard: `"Constant"` |
| `steps[].processingTime.value` | number | [OK] Ja | Zeitwert in Sekunden | - | **IMMER in Sekunden!** |
| `steps[].processingTime.unitId` | string | [OK] Ja | Zeiteinheit | `"s"` | **MUSS immer `"s"` sein!** |
| `steps[].resourceDemands` | array | [OK] Ja | Maschinenressourcen-Anforderungen | `[]` | Standard: leeres Array |
| `steps[].isParallelizable` | boolean | [OK] Ja | Parallelisierbarkeit | `false` | Standard: `false` |
| `links` | array | [OK] Ja | Verknüpfungen zwischen Schritten | `[]` | Standard: leeres Array |
...
| Feld | Datentyp | Required | Beschreibung | Default | Constraints |
|------|----------|----------|--------------|---------|-------------|
| `id` | string | [OK] Ja | Eindeutiger Bezeichner | - | Format: `{produktname}-bom` |
| `name` | string | [OK] Ja | BOM-Name | - | z.B. "Grey Pigment Paste BOM" |
| `baseQuantity` | number | [OK] Ja | Gesamtmenge | - | **MUSS exakte Summe aller Item-Quantities sein!** |
| `unitId` | string | [OK] Ja | Mengeneinheit | - | z.B. "g", "kg", "l", "ml" |
| `items` | array | [OK] Ja | Array von Materialien | - | Mindestens 1 Item |
| `items[].key` | string | [OK] Ja | Laufende Nummer | - | Format: "1", "2", "3", ... |
| `items[].material` | object | [OK] Ja | Materialreferenz | - | Siehe Sub-Struktur |
| `items[].material.version` | number | [OK] Ja | Versionsangabe | `1` | Immer `1` |
| `items[].material.id` | string | [OK] Ja | Material-ID | - | Muss existierendes Material referenzieren |
| `items[].quantity` | number | [OK] Ja | Menge des Materials | - | > 0 |
...
| Feld | Datentyp | Required | Beschreibung | Default | Constraints |
|------|----------|----------|--------------|---------|-------------|
| `id` | string | [OK] Ja | Eindeutiger Bezeichner | - | Format: `{produktname}-recipe` |
| `name` | string | [OK] Ja | Rezeptname | - | z.B. "Purple Pigment Paste Recipe" |
| `resultingMaterial` | object | [OK] Ja | Referenz zum Endprodukt-Material | - | Siehe Sub-Struktur |
| `resultingMaterial.version` | number | [OK] Ja | Versionsangabe | `1` | Immer `1` |
| `resultingMaterial.id` | string | [OK] Ja | Material-ID des Endprodukts | - | Muss existieren |
| `bom` | object | [OK] Ja | Referenz zur Stückliste | - | Siehe Sub-Struktur |
| `bom.version` | number | [OK] Ja | Versionsangabe | `1` | Immer `1` |
| `bom.id` | string | [OK] Ja | BOM-ID | - | Muss existieren |
| `productionProcess` | object | [OK] Ja | Referenz zum Prozess | - | Siehe Sub-Struktur |
| `productionProcess.version` | number | [OK] Ja | Versionsangabe | `1` | Immer `1` |
| `productionProcess.id` | string | [OK] Ja | Process-ID | - | Muss existieren |
...
### [FEHLER] Fehler 1: Product material.id ist Zutat statt Produkt
**Falsch:**
```json
{
  "id": "blue-pigment-paste-prod",
  "name": "Blue Pigment Paste",
  "material": {"version": 1, "id": "titanium-dioxide"} // [FEHLER] FALSCH
}
```
...
```json
{
  "id": "blue-pigment-paste-prod",
  "name": "Blue Pigment Paste",
  "material": {"version": 1, "id": "blue-pigment-paste"} // [OK] RICHTIG
}
```

---

### [FEHLER] Fehler 2: Zeiteinheit in Minuten statt Sekunden
**Falsch:**
```json
{
  "processingTime": {
...
```json
{
  "processingTime": {
    "type": "Constant",
    "value": 900,
    "unitId": "s" // [OK] RICHTIG (15 min × 60 = 900 s)
  }
}
```
...
### [FEHLER] Fehler 3: BOM baseQuantity falsch berechnet
**Falsch:**
```json
{
  "baseQuantity": 90, // [FEHLER] FALSCH (10+60+10+20 = 100)
  "items": [
    {"quantity": 10},
    {"quantity": 60},
    {"quantity": 10},
...
### [FEHLER] Fehler 4: Process-ID mit `-process` Suffix
**Falsch:**
```json
{
  "productionProcess": {
    "version": 1,
    "id": "dosing-mixing-filtration-packout-process" // [FEHLER] FALSCH
  }
}
```
...
```json
{
  "productionProcess": {
    "version": 1,
    "id": "dosing-mixing-filtration-packout" // [OK] RICHTIG
  }
}
```
