...
4. **Erfolgsmeldung prüfen**
   - ✅ "Successfully imported X materials"
...
3. **Import starten**
4. **Erfolgsmeldung prüfen:** ✅ "Successfully imported X machines"
...
3. **Import starten**
4. **Erfolgsmeldung prüfen:** ✅ "Successfully imported X products"
...
3. **Import starten**
4. **Erfolgsmeldung prüfen:** ✅ "Successfully imported X processes"
...
3. **Import starten**
4. **Erfolgsmeldung prüfen:** ✅ "Successfully imported X boms"
5. **BOM-Items prüfen:**
   - Öffne 1-2 BOMs
   - Prüfe baseQuantity
...
3. **Import starten**
4. **Erfolgsmeldung prüfen:** ✅ "Successfully imported X recipes"
...
**Häufige Fehler:**
- ❌ "BOM not found: [bom-id]"
- ❌ "Process not found: [process-id]"
- ❌ "Material not found" (in Recipe context)
- **Lösung 1:** Prüfen ob Version-Mismatch (siehe 7.2) - HÄUFIGSTE URSACHE!
...
**Soll = Ist?** → ✅ Import erfolgreich
**Soll ≠ Ist?** → ❌ Fehlende Entities, Import wiederholen
...
✅ Materials importieren **erfolgreich**
❌ BOMs/Products/Recipes Import schlägt fehl: **"Material not found"**
- IDs sind **korrekt**
...
✅ **Master Creator normalisiert automatisch alle Versionen auf 1**
